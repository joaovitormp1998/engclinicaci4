...
<head>
    ...
    <style>
        ...
        .card {
            ...
            box-shadow: 4px 5px 10px 3px brown;
        }
...
<body class="text-center">
    <main class="form-signin">
        <form action="<?php echo base_url('login/signIn') ?>" method="post">
            <img src="<?= base_url('156.png') ?>" alt=" imagem" width="300px" style="margin-bottom:20px;" alt=" imagem" width="300px">
            ...
            <input type="email" name="inputEmail" id="inputEmail" class="form-control" placeholder="Endereço de Email" required autofocus>
            ...
            <p style="margin-top:20px;"><a href="<?= base_url() ?>/recovery/">Esqueci minha senha ?</a></p>
