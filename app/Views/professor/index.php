...
<style>
    ...
    <section class="content">
        <div class="container-fluid">
                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#modalCadastroProfessor"><i class="fas fa-plus"></i>
                    
                </button>

            <table id="tb-professor" class="display">
                <thead>
                    <tr>
                        <th>Nome</th>
                        <th>Curso</th>
                ...
                <tbody>
                    <?php foreach ($professores as $professor) : ?>
                        <tr>
                            ...
                            <td><?= $cursoCombo [$professor->fk_curso];?></td>
                            <td><?= $professor->email ?></td>
                            <td><?= $professor->celular ?></td>
                            <td><a href="<?= base_url($_base . 'getDados/') ?>" class="btn-editar" data-id="<?= $professor->id ?>"><i class="far fa-edit"></i></a></td>
                            <td><a href="<?= base_url($_base . 'excluir/') ?>" class="btn-excluir" data-id="<?= $professor->id ?>"><i class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
...
<div class="modal fade" id="modalCadastroProfessor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCadastroProfessor" action="<?= base_url('professor/gravar') ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-8 col-sm-6">
                            ...
                            <?= form_dropdown('curso', $cursoCombo, false, 'id="curso" data-placeholder="Curso" ') ?>
                        </div>
                        <div class="form-group col-8 col-sm-6">
...
<div class="modal fade" id="modalExcluirProfessor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">

        <!-- <div class="modal" id="modalExcluirprofessor" tabindex="-1"> -->
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('professor/deletar') ?>" id="formExcluirProfessor" method="post">
                <div class="modal-body">
